                ...
                return (
                    <div className='cardPageContainer' key={item._id}>
                        ...
                        <div className='textContainer'>
                            ...
                            <p>${item.price}</p>
                            {!userInfo ? <button className=" addTocart cta" onClick={() => openModal(item._id)}>Agregar al carrito</button> : <button className="addToCart cta" onClick={() => openModal(item._id)}>Agregar al Carrito</button>}
